...
import { Loader2, CheckCircle2, AlertTriangle, XCircle, Terminal, FileImage } from "lucide-react";
      ...
      <div className="flex-shrink-0 px-4 py-2 border-b border-slate-800">
        <Tabs value={viewMode} onValueChange={(v) => onViewModeChange(v as ViewMode)}>
          <TabsList className="h-8 bg-slate-900 border border-slate-800">
            <TabsTrigger 
              value="terminal" 
              className="h-6 px-3 text-xs data-[state=active]:bg-slate-700 data-[state=active]:text-white text-slate-400"
            >
